...
namespace MSGym.Infrastructure.Migrations
{
    ...
    [Migration("20241229234855_Update-Domain")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RoleTrainingPlan", b =>
                {
                    b.Property<long>("ResponsibleRolesId")
                        .HasColumnType("bigint");

                    b.Property<long>("TrainingPlansId")
                        .HasColumnType("bigint");

                    b.HasKey("ResponsibleRolesId", "TrainingPlansId");

                    b.HasIndex("TrainingPlansId");

                    b.ToTable("RoleTrainingPlan");
                });
            ...
            modelBuilder.Entity("TrainingPlanUser", b =>
                {
                    ...
                    b.ToTable("TrainingPlanUser");
                });

            modelBuilder.Entity("ExerciseExerciseCategory", b =>
                {
                    b.HasOne("MSGym.Domain.Entities.ExerciseCategory", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RoleTrainingPlan", b =>
                {
                    b.HasOne("MSGym.Domain.Entities.Role", null)
                        .WithMany()
                        .HasForeignKey("ResponsibleRolesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TrainingPlanUser", b =>
                {
                    b.HasOne("MSGym.Domain.Entities.User", null)
                        .WithMany()
